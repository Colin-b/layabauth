...
- flask_restplus_common.add_monitoring_namespace (function is now within pycommon_server)
- flask_restplus_common.base_path (function is now private)
- flask_restplus_common.created_response (function is now within pycommon_server)
- flask_restplus_common.created_response_doc (function is now within pycommon_server)
- flask_restplus_common.updated_response (function is now within pycommon_server)
- flask_restplus_common.updated_response_doc (function is now within pycommon_server)
- flask_restplus_common.deleted_response (variable is now within pycommon_server)
- flask_restplus_common.deleted_response_doc (variable is now within pycommon_server)
- flask_restplus_common.PycommonApi (class is now private)
- flask_restplus_common.create_api (function is now within pycommon_server)
- configuration (functions are now within pycommon_server)
- logging_filter.RequestIdFilter (class is now within pycommon_server)
- "rest" optional dependency (not needed anymore as REST related code is in healthpy module)

### Changed
- RequestIdFilter only track request identifiers (CeleryTaskIdFilter class is now within flasynk and should be use to track celery tasks)
