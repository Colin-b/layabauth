...
class FlaskRestPlusTest(unittest.TestCase):
    ...
    def test_authentication_failure_invalid_key_identifier_in_token(self):
        ...
        with self.assertRaises(Unauthorized) as cm:
            get()
        self.assertEqual("SSQdhI1cKvhQEDSJxE2gGYs40Q0 is not a valid key identifier. Valid ones are ['FSimuFrFNoC0sJXGmv13nNZceDc', '2S4SCVGs8Sg9LS6AqLIq6DpW-g8'].", cm.exception.description)
